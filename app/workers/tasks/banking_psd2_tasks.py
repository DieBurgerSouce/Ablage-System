...
PSD2_BANKING_BEAT_SCHEDULE = {
    ...
    # Sync Tasks
    # =================================================================
    "psd2-sync-all-accounts-4h": {
        "task": "app.workers.tasks.banking_psd2_tasks.sync_all_bank_accounts",
    ...
    # =================================================================
    "psd2-refresh-consents-daily": {
        "task": "app.workers.tasks.banking_psd2_tasks.refresh_psd2_consents",
        "schedule": {
            "hour": 6,
            "minute": 30,
        },
        "kwargs": {"days_before_expiry": 7},
        "options": {"queue": "banking"},
    },
    "psd2-check-expired-connections-daily": {
        "task": "app.workers.tasks.banking_psd2_tasks.check_expired_connections",
        "schedule": {
            "hour": 7,
            "minute": 0,
        },
    ...
    # Auto-Reconciliation
    # =================================================================
    "psd2-auto-reconcile-hourly": {
        "task": "app.workers.tasks.banking_psd2_tasks.auto_reconcile_transactions",
    ...
    # Payment Processing
    # =================================================================
    "psd2-process-payments-hourly": {
        "task": "app.workers.tasks.banking_psd2_tasks.process_scheduled_payments",
        "schedule": 3600,  # Stuendlich
        "options": {"queue": "banking"},
    },
    # =================================================================
    # Health & Maintenance
    # =================================================================
    "psd2-health-check-2h": {
        "task": "app.workers.tasks.banking_psd2_tasks.update_connection_health",
        "schedule": 7200,  # Alle 2 Stunden
        "options": {"queue": "maintenance"},
    },
    "psd2-cleanup-logs-weekly": {
        "task": "app.workers.tasks.banking_psd2_tasks.cleanup_old_sync_logs",
        "schedule": {
            "day_of_week": "sunday",
            "hour": 3,
            "minute": 0,
