...
- _export_zip: ZIP-Export mit einzelnen JSON-Dateien
- _export_pdf: PDF-Export mit reportlab
"""
...
# Singleton-Instanz
_export_service_instance: DocumentExportService = None


def get_export_service() -> DocumentExportService:
    """Export-Service-Instanz abrufen (Singleton)."""
    global _export_service_instance
    if _export_service_instance is None:
        _export_service_instance = DocumentExportService()
