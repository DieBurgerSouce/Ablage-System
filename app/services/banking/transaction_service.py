...
class TransactionService:
    ...
    def _to_response(self, transaction: "BankTransaction") -> BankTransactionResponse:
        ...
        return BankTransactionResponse(
            ...
            parsed_invoice_numbers=transaction.parsed_invoice_numbers or [],
            parsed_customer_numbers=transaction.parsed_customer_numbers or [],
            parsed_references=transaction.parsed_references or [],
