...
| test_gobd_api.py | 16 F | laufende DB (503-Gate), Services gemockt | Container-Diagnose noetig; lokal maskiert 503 alles. Vermutung: Auth-/Dependency-Drift wie bei datev | Re-Run im Container nach conftest-Fixes, dann Drift einzeln triagieren |
| test_datev_api.py | 16 F | laufende DB (503-Gate) | wie test_gobd_api; zusaetzlich 401/403-Konventionsfrage (s. test_datev_connect_api) | wie test_gobd_api |
...
| test_backup_api.py | 7 F | laufende DB (503-Gate) | wie test_gobd_api | Container-Diagnose |
