#!/usr/bin/env python3
"""
/force-sonnet Command für Claude Code.
Erzwingt Sonnet-Modell für die nächste Task.
"""
...
try:
    ...
    orchestrator.set_override(OverrideMode.FORCE_SONNET)

    print("⚙️  Sonnet-Modus aktiviert")
    print("   Nächste Task wird mit Sonnet ausgeführt")
