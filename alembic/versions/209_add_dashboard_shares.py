...
Revises: 208_add_kanban_workflow
...
def upgrade() -> None:
    ...
    # Create dashboard_share_audits table
    op.create_table(
    ...
    # Create indexes for dashboard_share_audits
...
def downgrade() -> None:
    ...
    # Drop indexes for dashboard_share_audits
    ...
    # Drop dashboard_share_audits table
    op.drop_table('dashboard_share_audits')

    # Drop indexes for dashboard_shares
