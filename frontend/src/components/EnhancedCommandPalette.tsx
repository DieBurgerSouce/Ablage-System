    ...
    const allCommands: CommandAction[] = React.useMemo(() => {
        ...
        return [
            ...
            },
            {
                ...
                label: 'Proaktiver Assistent',
                description: 'KI-gesteuerte Handlungsempfehlungen',
                icon: Lightbulb,
                category: 'navigation',
                keywords: ['proaktiv', 'assistent', 'empfehlung', 'ki', 'vorschlag'],
                action: () => navigate({ to: '/proactive-assistant' }),
            },
            {
                id: 'nav-smart-dashboard',
                label: 'Smart Dashboard',
                description: 'Intelligentes KPI-Dashboard mit Widgets',
                icon: LayoutGrid,
                category: 'navigation',
                keywords: ['smart', 'dashboard', 'kpi', 'widget', 'kennzahl'],
                action: () => navigate({ to: '/smart-dashboard' }),
            },
            {
                id: 'nav-adhoc-reporting',
                label: 'Ad-Hoc Reports',
                description: 'Individuelle Berichte erstellen',
                icon: FileBarChart2,
                category: 'navigation',
                keywords: ['bericht', 'report', 'adhoc', 'auswertung', 'analyse'],
                action: () => navigate({ to: '/adhoc-reporting' }),
            },
            {
                id: 'nav-ust-voranmeldung',
                label: 'USt-Voranmeldung',
                description: 'Umsatzsteuer-Voranmeldung erstellen',
                icon: Euro,
                category: 'navigation',
                keywords: ['ust', 'umsatzsteuer', 'voranmeldung', 'steuer', 'finanzamt'],
                action: () => navigate({ to: '/german-finance/ust' }),
            },
            {
                id: 'nav-bwa',
                label: 'BWA',
                ...
                icon: FileBarChart2,
                category: 'navigation',
                keywords: ['bwa', 'betriebswirtschaftlich', 'auswertung', 'gewinn', 'verlust'],
                action: () => navigate({ to: '/german-finance/bwa' }),
            },
            {
                id: 'nav-cashflow-forecast',
                label: 'Cashflow-Prognose',
                description: 'Liquiditaetsplanung und Cashflow-Vorhersage',
                icon: Euro,
                category: 'navigation',
                keywords: ['cashflow', 'liquiditaet', 'prognose', 'forecast', 'planung'],
                action: () => navigate({ to: '/german-finance/cashflow' }),
            },
            ...
            ...(isAdmin
                ? [
                    ...
                    },
                    {
                        ...
                        label: 'Genehmigungsregeln',
                        description: 'Freigabe-Workflows konfigurieren',
                        icon: CheckCircle,
                        category: 'admin' as CommandCategory,
                        keywords: ['genehmigung', 'freigabe', 'approval', 'regel'],
                        action: () => navigate({ to: '/admin/approval-rules' }),
                    },
                    {
                        id: 'admin-approval-sla',
                        label: 'SLA-Dashboard',
                        description: 'Service Level Agreements ueberwachen',
                        icon: Gauge,
                        category: 'admin' as CommandCategory,
                        keywords: ['sla', 'service', 'level', 'ueberwachung'],
                        action: () => navigate({ to: '/admin/approval-sla' }),
                    },
                    {
                        id: 'admin-ki-pipeline',
                        label: 'KI-Pipeline',
                        description: 'Machine Learning Modelle verwalten',
                        icon: BrainCircuit,
                        category: 'admin' as CommandCategory,
                        keywords: ['ki', 'pipeline', 'ml', 'modell', 'training'],
                        action: () => navigate({ to: '/ki-pipeline' }),
                    },
                    {
                        id: 'admin-ki-learning',
                        label: 'KI-Lernprofile',
                        description: 'Lernprofile und Trainingshistorie',
                        icon: BrainCircuit,
                        category: 'admin' as CommandCategory,
                        keywords: ['lernprofil', 'training', 'ki', 'lernen'],
                        action: () => navigate({ to: '/ki-pipeline/learning' }),
                    },
                    {
                        id: 'admin-annotations',
                        label: 'Annotations-Aufgaben',
                        description: 'Dokument-Annotationen verwalten',
                        icon: Pen,
                        category: 'admin' as CommandCategory,
                        keywords: ['annotation', 'markierung', 'aufgabe', 'label'],
                        action: () => navigate({ to: '/admin/annotation-tasks' }),
                    },
                ]
                : []),
