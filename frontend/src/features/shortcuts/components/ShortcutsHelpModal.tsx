/**
 * ShortcutsHelpModal - Modal showing all available keyboard shortcuts
 *
 * Features:
...
const categoryConfig: Record<ShortcutCategory, {
  ...
  actions: {
    ...
    description: 'Aktionen fuer ausgewaehlte Elemente',
  },
  documents: {
      ...
      >
        ...
        <div className="pt-4 border-t border-border">
          <div className="text-xs text-muted-foreground text-center space-y-1">
            ...
            <p>
              <ShortcutBadge keys="ctrl+k" className="mx-1 inline-flex" /> oeffnet die Befehlspalette.
            </p>
            <p className="mt-2">
