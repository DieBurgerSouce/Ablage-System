...
export const INVOICE_FIELD_CONFIGS: FieldConfig[] = [
  ...
  { key: 'recipient', label: 'Recipient', german_label: 'Rechnungsempfänger', type: 'text', editable: true, required: true },
...
export const CONTRACT_FIELD_CONFIGS: FieldConfig[] = [
  ...
  { key: 'notice_period', label: 'Notice Period', german_label: 'Kündigungsfrist', type: 'text', editable: true, required: false },
  ...
  { key: 'auto_renewal', label: 'Auto Renewal', german_label: 'Automatische Verlängerung', type: 'text', editable: true, required: false },
  { key: 'termination_notice', label: 'Termination Notice', german_label: 'Kündigungshinweis', type: 'text', editable: true, required: false },
