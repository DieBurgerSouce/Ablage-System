...
export const TOURS: Tour[] = [
  ...
  {
    id: 'workflow-builder',
    name: 'Workflow-Builder kennenlernen',
    description: 'Erstellen Sie visuelle Workflows per Drag & Drop.',
    category: 'fortgeschritten',
    estimatedMinutes: 3,
    badge: {
      id: 'automatisierer',
      name: 'Automatisierer',
      description: 'Sie wissen, wie man Workflows erstellt!',
      icon: 'Workflow',
    },
    steps: [
      {
        id: 'wf-palette',
        title: 'Block-Palette',
        description: 'Hier finden Sie alle Bausteine fuer Ihren Workflow: Aktionen, Bedingungen, Benachrichtigungen und mehr.',
        targetSelector: '[data-tour="wf-palette"]',
        position: 'right',
        order: 1,
        icon: 'Boxes',
      },
      {
        id: 'wf-canvas',
        title: 'Canvas',
        description: 'Ziehen Sie Bloecke aus der Palette auf diese Arbeitsflaeche, um Ihren Workflow aufzubauen.',
        targetSelector: '[data-tour="wf-canvas"]',
        position: 'bottom',
        order: 2,
        icon: 'Layout',
      },
      {
        id: 'wf-config',
        title: 'Block konfigurieren',
        description: 'Waehlen Sie einen Block aus, um seine Einstellungen im rechten Panel anzupassen.',
        targetSelector: '[data-tour="wf-config"]',
        position: 'left',
        order: 3,
        icon: 'Settings',
      },
      {
        id: 'wf-connections',
        title: 'Verbindungen',
        description: 'Ziehen Sie von einem Ausgangs-Handle zu einem Eingangs-Handle, um Bloecke zu verbinden.',
        targetSelector: '[data-tour="wf-canvas"]',
        position: 'bottom',
        order: 4,
        icon: 'GitBranch',
      ...
      {
        id: 'wf-actions',
        title: 'Speichern & Simulieren',
        description: 'Testen Sie Ihren Workflow mit der Simulation und speichern Sie ihn anschliessend.',
        targetSelector: '[data-tour="wf-actions"]',
        position: 'bottom',
        order: 5,
        icon: 'Play',
      },
  ...
  {
    id: 'knowledge-graph',
    name: 'Wissens-Graph erkunden',
    description: 'Visualisieren Sie Beziehungen zwischen Dokumenten und Entitaeten.',
    category: 'fortgeschritten',
    estimatedMinutes: 2,
    badge: {
      id: 'netzwerker',
      name: 'Netzwerker',
      description: 'Sie kennen den Wissens-Graph!',
      icon: 'Share2',
    },
    steps: [
      {
        id: 'kg-search',
        title: 'Entitaet suchen',
        description: 'Finden Sie Unternehmen, Dokumente oder Personen ueber die Suchleiste.',
        targetSelector: '[data-tour="kg-search"]',
        position: 'bottom',
        order: 1,
        icon: 'Search',
      },
      {
        id: 'kg-canvas',
        title: 'Graph-Ansicht',
        description: 'Die interaktive Beziehungsvisualisierung zeigt Verbindungen zwischen Entitaeten und Dokumenten.',
        targetSelector: '[data-tour="kg-canvas"]',
        position: 'bottom',
        order: 2,
        icon: 'Share2',
      },
      {
        ...
        description: 'Wechseln Sie zwischen Graph, Finanzkette, Zeitstrahl, Risiko und Familien-Ansicht.',
        targetSelector: '[data-tour="kg-toolbar"]',
        position: 'bottom',
        order: 3,
        icon: 'LayoutGrid',
      },
      {
        id: 'kg-details',
        title: 'Detail-Panel',
        description: 'Klicken Sie auf einen Knoten, um Eigenschaften und Beziehungen einer Entitaet zu sehen.',
        targetSelector: '[data-tour="kg-details"]',
        position: 'left',
        order: 4,
        icon: 'Info',
      },
