/**
 * DeadlineEditDialog - Dialog zum Bearbeiten einer Frist
 */
...
import type { PrivatDeadlineWithStatus, PrivatDeadlineUpdate, PrivatDeadlineType } from '@/types/privat';

interface DeadlineEditDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  deadline: PrivatDeadlineWithStatus | null;
  onSubmit: (deadlineId: string, data: PrivatDeadlineUpdate) => Promise<void>;
  isLoading?: boolean;
}
...
export function DeadlineEditDialog({
  ...
  const [formData, setFormData] = React.useState<PrivatDeadlineUpdate>({});
  ...
  React.useEffect(() => {
    if (deadline) {
      setFormData({
        ...
        dueDate: deadline.dueDate.split('T')[0], // Format as YYYY-MM-DD
        isRecurring: deadline.isRecurring,
        recurrenceInterval: deadline.recurrenceInterval || undefined,
      ...
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Bearbeiten Sie die Details dieser Frist.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => setFormData({
                  ...formData,
                  isRecurring: checked,
                  recurrenceInterval: checked ? (formData.recurrenceInterval || 'annually') : undefined
                })}
                disabled={isLoading}
              />
            </div>
