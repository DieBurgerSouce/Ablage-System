...
export const MOCK_SUPPLIERS: Supplier[] = [
  ...
  {
    id: 'stahl-mueller',
    name: 'Stahlwerk Müller GmbH & Co. KG',
    displayName: 'Stahl Müller',
    isActive: true,
    lastActivityDate: '2024-12-22',
    folders: [
      {
